...
const data = [
    ...
    { Nome: "Tamara CEO", Pontos: 5, Motivo: "Participação em Evento - Exemplo 2", Data: new Date().toLocaleDateString('pt-BR') }
];
...
const filePath = path.join(__dirname, '../frontend/modelo_pontuacao_diaria.xlsx');
