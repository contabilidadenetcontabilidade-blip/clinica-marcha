...
console.log("=== MIGRAÇÃO FORÇADA CARTAS 2026 ===");

db.serialize(() => {
    // DROP tables to ensure clean state
    db.run("DROP TABLE IF EXISTS student_cards");
    ...
    db.run(`CREATE TABLE student_cards (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
    ...
    console.log("Tabelas 'cards' e 'student_cards' recriadas (DROP & CREATE).");
