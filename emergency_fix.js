...
db.serialize(() => {
    ...
    // For curinga.jpg -> coringa.jpeg, etc
    const imageMappings = {
        'alianca.jpg': 'alianca.jpeg',
        'curinga.jpg': 'coringa.jpeg',
        'golpe.jpg': 'golpe de estado.jpeg',
        'influenciador.jpg': 'influencer.jpeg',
        'invisibilidade.jpg': 'invisibilidade.jpeg',
        'ladrao.jpg': 'ladino.jpeg',
        'maromba.jpg': 'marombinha.jpeg',
        'reverso.jpg': 'reverso.jpeg',
        'senhor.jpg': 'senhorinha.jpeg',
        'spoiler.jpg': 'spoiler.jpeg',
        'tandera.jpg': 'tandera.jpeg',
        'trapaca.jpg': 'trapaca.jpeg',
        'var.jpg': 'var.jpeg',
        'vida.jpg': 'vida.jpeg',
        'zica.jpg': 'zica.jpeg'
    };

    // Note: just update all entries to ensure they point to correct files
    ...
    // Let's just fix the prefix for all
